    ...
    <div className="flex items-center justify-between border-b p-2">
      <div className="flex items-center gap-3 overflow-hidden">
        <div
          ...
          onClick={
            isSvg && onEditSvg ? onEditSvg : canPreview && !isImage ? handlePreview : undefined
          }
          title={
            isSvg && onEditSvg
              ? 'Edit SVG'
        ...
        <div className="flex min-w-0 flex-col gap-0.5">
          <div className="flex items-center gap-2">
            <span
              ...
              title={
                canPreview && !isImage ? `Click to preview ${queuedFile.file.name}` : undefined
              }
            >
          ...
          {queuedFile.error && <p className="text-xs text-destructive">{queuedFile.error}</p>}
        </div>
      </div>
      <div className="flex items-center gap-1">
        {isSvg && onEditSvg && (
