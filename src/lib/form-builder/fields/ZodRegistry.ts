...
// import { richeditorToZod } from './RichEditor/richeditor.zod'; // TODO: Removed due to Plate.js issues
...
const zodRegistry: Record<FieldType, ZodConverter> = {
    ...
    // richeditor: richeditorToZod as ZodConverter, // TODO: Removed due to Plate.js issues
