          ...
          const items = Object.entries(globals.data).map(([key, item]: [string, any]) => {
            ...
            if (typeof val === 'string') {
              ...
              if (targetLocale in val || defaultLocale in val) {
                ...
                displayValue =
                  typeof localizedVal === 'string' ? localizedVal : JSON.stringify(localizedVal);
              } else {
      ...
      <div className={cn('relative w-full', className)}>
        ...
        >
          ...
          >
            ...
            {!diffMode && maxLength && <MaxLengthPlugin maxLength={maxLength} />}
            ...
            {diffMode && <DiffPlugin oldValue={diffOldValue} newValue={value} enabled={diffMode} />}
          </div>
        </GlobalVariableSelect>
      </div>
