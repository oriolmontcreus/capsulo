...
function FloatingTextFormat({
  ...
  return (
    <div
      ...
      className="bg-popover absolute top-0 left-0 z-[9999] flex gap-1 rounded-md border p-1 opacity-0 shadow-md transition-opacity duration-75 will-change-transform"
    >
      {editor.isEditable() && (
        <>
          <ToggleGroup
