...
import { ImageIcon, Cloud, Zap } from "lucide-react";
...
// Component that shows which model will be used - MUST be inside PromptInput
function ModelIndicator() {
    ...
    return (
        <div className="text-[10px] text-muted-foreground flex items-center gap-1.5 ml-1">
            {hasAttachments ? (
                <>
                    <Cloud className="size-3 text-orange-500" />
