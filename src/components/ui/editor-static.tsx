...
export const editorVariants = cva(
  cn(
    ...
    'placeholder:text-muted-foreground/80 **:data-slate-placeholder:top-[auto_!important] **:data-slate-placeholder:text-muted-foreground/80 **:data-slate-placeholder:opacity-100! bg-sidebar rounded-t-none',
    '[&_strong]:font-bold'
  ),
  {
    defaultVariants: {
