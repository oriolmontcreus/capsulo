...
const config: CapsuloConfig = {
  ...
  github: {
     ...
     */
    owner: import.meta.env.PUBLIC_GITHUB_REPO_OWNER || 'your-github-username',

    /**
     * The GitHub repository name
     * @example "your-repo-name"
     */
    repo: import.meta.env.PUBLIC_GITHUB_REPO_NAME || 'your-repo-name',
  },
  ...
  app: {
     ...
     */
    authWorkerUrl:
      import.meta.env.PUBLIC_AUTH_WORKER_URL ||
      'https://your-auth-worker.your-subdomain.workers.dev',
  },
